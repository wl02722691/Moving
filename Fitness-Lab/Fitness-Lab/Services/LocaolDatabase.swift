...
class LocaolDatabase {
    ...
    private let fitCategories = [
        ...
        FitnessModel(title: "全身運動", imageName: "1", secondTitle: "All Workout"),
        FitnessModel(title: "腹部運動", imageName: "2", secondTitle: "Abs Workout"),
        FitnessModel(title: "手臂運動", imageName: "4", secondTitle: "Arm Workout"),
        FitnessModel(title: "腿部運動", imageName: "5", secondTitle: "Leg Workout")
